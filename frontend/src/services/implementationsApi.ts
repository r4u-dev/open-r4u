...
export class ImplementationsApiService {
    ...
    ): Promise<ApiResponse<ImplementationRead>> {
        return apiClient.post<ImplementationRead>(
    ...
    async getImplementation(
        ...
        return apiClient.get<ImplementationRead>(
            `${this.baseEndpoint}/${implementationId}`,
        );
    }
    ...
    async updateImplementation(
        ...
        return apiClient.put<ImplementationRead>(
            `${this.baseEndpoint}/${implementationId}`,
            payload,
        );
    }

    async deleteImplementation(
        implementationId: number,
    ...
    async setProductionVersion(
        ...
        return apiClient.post<ImplementationRead>(
            `${this.baseEndpoint}/${implementationId}/set-production`,
        );
    }
}
