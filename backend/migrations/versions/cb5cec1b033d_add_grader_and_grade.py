...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("score_type", score_type_enum, nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["project_id"],
            ["project.id"],
            name=op.f("fk_grader_project_id_project"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["execution_result_id"],
            ["execution_result.id"],
            name=op.f("fk_grade_execution_result_id_execution_result"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["grader_id"],
            ["grader.id"],
            name=op.f("fk_grade_grader_id_grader"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["trace_id"],
            ["trace.id"],
            name=op.f("fk_grade_trace_id_trace"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_grade")),
    )
    op.create_index(
        "ix_grade_execution_result_id",
        "grade",
        ["execution_result_id"],
        unique=False,
    )
