...
class TemplateInferrer:
    ...
    def _find_positions_in_all(self, substring: str, strings: List[str]) -> Optional[List[int]]:
    ...
    def _build_segments(self, strings: List[str], anchors: List[str]) -> List[Tuple[Optional[str], bool]]:
    ...
    def _construct_template(self, segments: List[Tuple[Optional[str], bool]]) -> str:
